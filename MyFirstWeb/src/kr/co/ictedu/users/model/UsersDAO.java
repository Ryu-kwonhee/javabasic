package kr.co.ictedu.users.model;
import java.sql.*;
//<<<<<<< HEAD
...
//	private static final String DBPW = "mysql";
	 ...
	 * 메모리 관리 차원에서 클래스	\의 객체를 단 1개만 생성하도록
...
//		}
	...
	// usersDelete
	// 원래 대다스 DAO는 UsersVO 하나로 모든 처리를 해결할 수 있습니다.
	...
	// 사용하는 메서드로 아이디, 비밀번호, 이름, 이메일을 UserVO에 넣어서
	// 리턴합니다.
