...
public class JdbcConnection {
	public static void main(String[] args) {
		...
		// Connector J는 MySQL 공식홈페이지에서 다운받아 설치할 수도 있고 
		...
		// jar파일을 추가해줘야합니다.
		// 프로젝트별로 계속 추가해야하니 방법을 잘 기억해두세요.
		// 1. 프로젝트 우클릭 -> properties -> 좌측탭의 java build path
		// 2. 상단탭의 libraries 선택 후 우측의 Add library 선택
		// 3. user library 선택 후 우측 user libraries 선택
		// 4. 우측 new버튼 누르고 이름 임의로 입력 (현재 jdbc connection)
